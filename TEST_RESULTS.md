...
Прогон: `cd backend && python -m pytest -q` → **358 passed** (после вебхуков и прямого подключения Instagram;
...
| Подключение Instagram по токену | 03 | `tests/test_ig_connect.py` | 28 | 🟢 PASS |
