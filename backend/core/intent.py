...
RULES = [
    ...
    # «создай по плану», «что там на понедельник» — человек хочет увидеть план
    # и запустить из него пункт, а не составлять новый.
    (("по плану", "из плана", "на понедельник", "на вторник", "на среду",
      "на четверг", "на пятницу", "на субботу", "на воскресенье",
      "покажи план", "мой план"), "/plan"),
...
INTENT_SYSTEM = (
    ...
    "/director <задача> — СЛОЖНАЯ задача в несколько шагов, которую не покрывает\n"
    "  ни одна команда выше: дирижёр сам разложит её на агентов и инструменты\n"
